...
class Imovel_Parceiro_Checkout_Cleanup {
	...
	public function __construct() {
		// Layout fresco stitch: apenas ordenação de campos + ocultar totais recorrentes; headers/cupom via template
	...
	public function layout_field_sizes( $fields ) {
		$map = array(
			...
			'billing_postcode'      => array( 'first', 42 ),
			...
			'billing_city'          => array( 'first', 70 ),
			'billing_state'         => array( 'last', 75 ),
			...
			'shipping_postcode'     => array( 'first', 42 ),
			...
			'shipping_city'         => array( 'first', 70 ),
			'shipping_state'        => array( 'last', 75 ),
		);
