...
<!-- Breadcrumbs & Steps (unico) -->
<div class="mb-8 space-y-4">
  <nav aria-label="Breadcrumb" class="flex text-xs font-medium text-slate-500">
    <ol class="inline-flex items-center space-x-1.5 md:space-x-2">
      <li class="inline-flex items-center"><a class="hover:text-brand-600 flex items-center gap-1" href="<?php echo esc_url(home_url('/')); ?>"><svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"></path></svg>Home</a></li>
...
<div class="mb-8">
  <div class="bg-white border border-blue-100 rounded-2xl p-4 sm:p-5 shadow-[0_2px_8px_-2px_rgba(15,23,42,.05)]">
    <div class="flex items-center gap-3 text-sm text-slate-700 font-medium">
      <span class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center border border-blue-100"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg></span>
      <span>Tem um cupom promocional ou convite de imobiliária? <a href="#" class="ipc-showcoupon text-brand-600 font-bold underline underline-offset-2">Clique aqui para digitar seu cupom</a></span>
    </div>
    <form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none; margin-top:1rem;">
      <p class="form-row form-row-first"><input type="text" name="coupon_code" class="input-text border-slate-300 rounded-xl px-3.5 py-2.5 text-sm font-mono uppercase w-full" placeholder="<?php esc_attr_e('Código do cupom','woocommerce'); ?>" /></p>
      <p class="form-row form-row-last"><button type="submit" name="apply_coupon" value="<?php esc_attr_e('Aplicar cupom','woocommerce'); ?>" class="button px-5 py-2.5 text-sm font-semibold rounded-xl bg-slate-900 text-white w-full"><?php esc_html_e('Aplicar cupom','woocommerce'); ?></button></p>
      <div class="clear"></div>
    </form>
  </div>
</div>
