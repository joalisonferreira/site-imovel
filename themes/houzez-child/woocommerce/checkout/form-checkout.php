...
<div class="mb-8">
  <div class="bg-white border border-blue-100 rounded-2xl p-4 sm:p-5 shadow-[0_2px_8px_-2px_rgba(15,23,42,.05)]">
    <div class="flex items-center gap-3 text-sm text-slate-700 font-medium">
      ...
      <span>Tem um cupom promocional ou convite de imobiliária? <a href="#" class="showcoupon text-brand-600 font-bold underline underline-offset-2">Clique aqui para digitar seu cupom</a></span>
    </div>
    <div class="checkout_coupon woocommerce-form-coupon hidden mt-4">
      ...
      <p class="form-row form-row-last"><button type="button" class="button px-5 py-2.5 text-sm font-semibold rounded-xl bg-slate-900 text-white w-full"><?php esc_html_e('Aplicar cupom','woocommerce'); ?></button></p>
      <div class="clear"></div>
    </div>
  </div>
</div>
